...
export const TTL = {
  QUEUE:  2 * 60 * 1000,       // 2 min   — active orders list (+ 30s poll)
  SHORT:  10 * 60 * 1000,      // 10 min  — patient history
  MEDIUM: 60 * 60 * 1000,      // 1 hour  — test catalog display list
  LONG:   24 * 60 * 60 * 1000, // 24 hours — test search results
}
...
// stale-while-revalidate — show cached instantly, refresh silently
...
// one-shot — return cached if fresh, else fetch (for search autocomplete)
