      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            <div className="text-2xl font-extrabold" style={{ color: '#7C3AED' }}>BHarath Health Systems</div>
            <div className="text-sm mt-1 font-medium text-gray-500">Lab</div>
          </div>
          <div className="bg-white rounded-2xl shadow-md p-6 space-y-4">
            {forgotSent ? (
              <div className="text-center space-y-4">
                <CheckCircle className="mx-auto" size={40} style={{ color: '#7C3AED' }}/>
                ...
                <button onClick={() => { setMode('login'); setForgotSent(false); setForgotForm({ identifier: '', note: '' }) }}
                  ...
                  style={{ background: '#7C3AED' }}>Back to Login</button>
              </div>
            ) : (
              <>
  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      >
        ...
        <div className="text-xs" style={{ color: '#93c5fd' }}>BHarath Health Systems · Laboratory Portal</div>
      </div>
