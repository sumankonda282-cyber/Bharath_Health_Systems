    ...
    <div className="flex h-screen overflow-hidden bg-[#F0F4F8]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <PortalTopBar
          ...
          pageTitle={pageTitle} portalSource="Pharmacy"
          onToggleSidebar={toggleCollapsed} onMenuClick={() => setMobileOpen(true)}
          rightExtra={<AlertsBell />} showBell={false}
        />
