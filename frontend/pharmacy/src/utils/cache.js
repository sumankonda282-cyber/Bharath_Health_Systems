const DB_NAME = 'bh_pharmacy_cache'
const DB_VERSION = 1
...
export const TTL = {
  SHORT:  5 * 60 * 1000,        // 5 min   — stock transactions (changes often)
  MEDIUM: 10 * 60 * 1000,       // 10 min  — inventory, billing, history
  LONG:   24 * 60 * 60 * 1000,  // 24 hours — medicine search catalog
}
...
export async function cachedFetch(key, apiFn, onFresh, ttl = TTL.MEDIUM) {
...
// one-shot (for search autocomplete)
