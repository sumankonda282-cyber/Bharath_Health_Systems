  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-400 mb-6 leading-relaxed">
        By submitting, you agree to BHarath Health Systems's Terms of Service and Privacy Policy. Registration will be reviewed within 24 hours.
      </p>
  ...
  return (
    <div className="text-center py-8">
      ...
      <p className="text-gray-500 mb-2 max-w-sm mx-auto">
        Thank you for registering with BHarath Health Systems. Your clinic is <strong className="text-yellow-600">pending approval</strong>.
      </p>
