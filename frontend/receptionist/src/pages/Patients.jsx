    ...
    <div>
      ...
      <div className="card overflow-hidden">
        {loading
          ...
          : patients.length === 0
            ? <div className="p-10 text-center text-gray-400"><Users size={32} className="mx-auto mb-2 opacity-30" /><p>No patients found</p></div>
            : (
                ...
                <table className="table">
                  <thead>
                    <tr>
                      ...
                      <th className="th">BHID</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {patients.map(p => (
                      <tr key={p.id} className="tr-hover cursor-pointer" onClick={() => setSelectedPatient(p)}>
                        ...
                        <td className="td text-xs font-mono text-gray-500">{p.bh_id || '—'}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
