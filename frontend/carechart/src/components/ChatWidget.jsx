  ...
  return (
    <div className="relative">
      <select
        ...
        className="w-full appearance-none border border-gray-200 rounded-lg px-3 py-2 text-sm pr-8 focus:outline-none focus:border-green-400 bg-white text-gray-700"
      >
  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div className="flex items-center gap-2 px-4 py-3 flex-shrink-0" style={{ background: GREEN }}>
            {(view === 'chat' || view === 'new') && (
            ...
            {view === 'chat' && (
              <>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-green-200 text-xs">{ROLE_LABEL[activeContact?.role] || activeContact?.role}</div>
                </div>
              </>
            )}
            ...
            <>
                  ...
                  return (
                    <div key={msg.id} className={`flex ${isMine ? 'justify-end' : 'justify-start'}`}>
                      ...
                      >
                        ...
                        <div>{msg.body}</div>
                        <div className={`text-xs mt-0.5 ${isMine ? 'text-green-200' : 'text-gray-400'} text-right`}>
              ...
              <div className="px-3 pb-3 pt-2 border-t border-gray-100 flex gap-2 flex-shrink-0">
                <button
                  ...
                  style={{ background: showShortcuts ? GREEN : '#f3f4f6', color: showShortcuts ? 'white' : '#6b7280' }}
                  title="Quick replies"
                >⚡</button>
                <input
                  value={input}
                  ...
                  className="flex-1 rounded-full border border-gray-200 px-4 py-1.5 text-sm focus:outline-none focus:border-green-400"
                  style={{ minWidth: 0 }}
                />
                <button
