...
export const SEARCH_TYPES = {
  ...
  medication_search: { url: '/terminology/drugs/search', params: q => ({ q, limit: 10, scope: 'all' }),           label: r => r.primary_brand || r.name || r.generic, sub: r => [r.generic, r.in_stock ? '● In stock' : 'Orderable'].filter(Boolean).join(' · '), ph: 'Search brand or generic…' },
