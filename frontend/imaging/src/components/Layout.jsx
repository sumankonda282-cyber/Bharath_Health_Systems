...
import {
  LayoutDashboard, ScanLine, FileEdit, CreditCard, BarChart2, Users, X, Bell,
  FileText, CheckCircle, Calendar, UserCheck, ClipboardList,
} from 'lucide-react'
...
// ── Critical Alerts Bell (imaging-specific — kept as the portal's bell) ────────
        ...
        {isCollapsed ? (
          ...
          <>
            <div className="flex flex-col gap-1 min-w-0">
              ...
              <span className="text-[10px] font-bold tracking-widest uppercase pl-0.5" style={{ color: '#F5821E' }}>Imaging</span>
            </div>
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <PortalTopBar
          ...
          pageTitle={pageTitle} portalSource="Imaging" roleLabel={roleLabel}
          onToggleSidebar={toggleCollapsed} onMenuClick={() => setOpen(true)}
          rightExtra={<CriticalAlertsBell />} showBell={false}
        />
