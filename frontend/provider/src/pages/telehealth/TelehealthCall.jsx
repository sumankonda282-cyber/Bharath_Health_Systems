...
export default function TelehealthCall() {
  ...
  if (loading) return (
    <div className="h-screen flex items-center justify-center bg-gray-900">
      <div className="text-center">
        ...
        <p className="text-gray-300 text-sm">Connecting to video room…</p>
      </div>
    </div>
  )
  ...
  if (error) return (
    <div className="h-screen flex items-center justify-center bg-gray-900">
      <div className="text-center max-w-sm px-4">
        ...
        <p className="text-white font-semibold mb-2">Cannot Join Call</p>
  ...
  if (ended) return (
    <div className="h-screen flex items-center justify-center bg-gray-900">
      <div className="text-center max-w-sm px-4">
        ...
        <p className="text-white text-xl font-bold mb-2">Consultation Ended</p>
        {rejoinMins > 0 && (
          <p className="text-gray-400 text-sm mb-2">Patient can rejoin for {rejoinMins} minutes.</p>
        )}
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-900">
      {/* Info bar */}
      <div className="flex items-center gap-4 px-5 py-3 flex-shrink-0" style={{ background: '#0F2557' }}>
        ...
        {joinData?.window_ends_at && (
          <span className="flex items-center gap-1 text-xs text-blue-300 ml-2">
            <Clock size={12} />
