...
| 3 | **receptionist** | `frontend/receptionist/` | Front desk: registration, appointments, scheduling, billing | `staff.bharathhealthsystems.com` | `/inpatient/*`, `/clinic/*`, `/scheduler/*`, `/patients/*`, `/appointments/*`, `/chat/*`, `/billing/*`, `/maintenance/*`, `/terminology/*`, `/forms/*` |
